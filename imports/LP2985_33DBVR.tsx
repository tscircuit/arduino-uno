...
export const LP2985_33DBVR = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			pinLabels={pinLabels}
			supplierPartNumbers={{
			...
			manufacturerPartNumber="LP2985_33DBVR"
			footprint={
				<footprint>
					<smtpad
						portHints={["pin5"]}
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C95414.obj?uuid=460193f9bf2d42e58cf3c2f675b07dc6",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C95414.step?uuid=460193f9bf2d42e58cf3c2f675b07dc6",
