...
export const SS14 = (props: ChipProps<typeof pinLabels>) => {
  ...
  "jlcpcb": [
    "C2480"
      ...
      footprint={<footprint>
        <smtpad portHints={["pin2"]} pcbX="1.9649440000000595mm" pcbY="0mm" width="1.5199868mm" height="1.6800068mm" shape="rect" />
<smtpad portHints={["pin1"]} pcbX="-1.9649440000000595mm" pcbY="0mm" width="1.5199868mm" height="1.6800068mm" shape="rect" />
...
<silkscreenpath route={[{"x":2.099995799999988,"y":-1.2999973999999384},{"x":-2.099995799999988,"y":-1.2999973999999384}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=2ad98c37c5614ad18681cbd22e4725e1&pn=C2480",
        rotationOffset: { x: 0, y: 0, z: 0 },
        positionOffset: { x: 0, y: 0, z: -0.040003400000000466 },
      }}
      {...props}
    />
  )
