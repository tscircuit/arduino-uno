...
export const ATMEGA328P_AU = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
				...
				<footprint>
					...
					<silkscreenpath
						route={[
							...
							{ x: -3.907941055997668, y: -3.9133579702960617 },
							{ x: -3.7579300000000018, y: -3.763980575985258 },
							{ x: -3.6079189440023356, y: -3.9133579702960617 },
					...
					<silkscreenpath
						route={[
							...
							{ x: -2.4015150142161303, y: -1.86006255080585 },
							{ x: -2.3284212288967012, y: -1.6370321891015465 },
							{ x: -2.0937187711032834, y: -1.6370321891015465 },
							{ x: -2.0206249857838543, y: -1.86006255080585 },
							{ x: -2.209799999999987, y: -1.998980000000003 },
						]}
					/>
					<courtyardoutline
						outline={[
							{ x: -5.228400000000008, y: 5.215700000000012 },
							{ x: 5.2283999999999935, y: 5.215700000000012 },
							{ x: 5.2283999999999935, y: -5.215699999999998 },
							{ x: -5.228400000000008, y: -5.215699999999998 },
							{ x: -5.228400000000008, y: 5.215700000000012 },
						]}
					/>
				</footprint>
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C14877.obj?uuid=4d9f6c3430024506b87ce44b53201fc5",
